...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('seat_name')); ?>:</b>
	<?php echo CHtml::encode($data->seat_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_window_seat')); ?>:</b>
	<?php echo CHtml::encode($data->is_window_seat == '0')?"No window seat":"Window seat"; ?>
	<br />
